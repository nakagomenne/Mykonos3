...
/* 電話アイコン（不在登録用） */
export const PhoneMissedIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" />
  </svg>
);
...
const userIconPath = "M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z";

export const UsersGroupIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 52 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-auto h-6'}>
        <g transform="translate(0,0)">
             <path strokeLinecap="round" strokeLinejoin="round" d={userIconPath} vectorEffect="non-scaling-stroke" />
        </g>
...
export const CloudArrowUpIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
...
export const Cog6ToothIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.343 3.94c.09-.542.56-1.007 1.11-1.226l.554-.221a17.54 17.54 0 0 1 4.966 0l.554.221c.55.219 1.02.684 1.11 1.226l.099.591a17.523 17.523 0 0 1 3.445 3.445l.591.099c.542.09.95.49 1.226 1.11l.221.554a17.54 17.54 0 0 1 0 4.966l-.221.554c-.276.62-.731.986-1.226 1.11l-.591.099a17.523 17.523 0 0 1-3.445 3.445l-.099.591c-.09.542-.56 1.007-1.11 1.226l-.554.221a17.54 17.54 0 0 1-4.966 0l-.554-.221c-.55-.219-1.02-.684-1.11-1.226l-.099-.591a17.523 17.523 0 0 1-3.445-3.445l-.591-.099c-.542-.09-1.007-.56-1.226-1.11l-.221-.554a17.54 17.54 0 0 1 0 4.966l.221-.554c.276-.62.731.986 1.226 1.11l.591-.099A17.523 17.523 0 0 1 6.9 7.385l.099-.591ZM12 15.75a3.75 3.75 0 1 0 0-7.5 3.75 3.75 0 0 0 0 7.5Z" />
  </svg>
);

export const ArrowRightStartOnRectangleIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
...
export const SpeechBubbleIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className || 'w-6 h-6'}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 2H3c-0.55 0-1 0.45-1 1v14c0 0.55 0.45 1 1 1h3v4l4-4h11c0.55 0 1-0.45 1-1V3c0-0.55-0.45-1-1-1z" />
    </svg>
);
...
export const FlagIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 3v18m0-13.5 6-1.5 6 1.5 6-1.5v9l-6 1.5-6-1.5-6 1.5" />
  </svg>
);
...
/* いいね済み用サムズアップアイコン（塗りつぶし） */
export const ThumbUpSolidIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className || 'w-6 h-6'}>
    <path d="M1 8.25a1.25 1.25 0 1 1 2.5 0v7.5a1.25 1.25 0 1 1-2.5 0v-7.5ZM11 3V1.7c0-.268.14-.526.395-.607A2 2 0 0 1 14 3c0 .995-.182 1.948-.514 2.826-.204.53.16 1.174.72 1.174h2.52c1.243 0 2.261 1.01 2.146 2.247a23.864 23.864 0 0 1-1.341 5.974C17.153 16.323 16.072 17 14.9 17h-3.192a3 3 0 0 1-1.341-.317l-2.734-1.366A3 3 0 0 0 6.292 15H5V8h.963c.685 0 1.258-.483 1.612-1.068a4.011 4.011 0 0 1 2.166-1.73c.432-.143.853-.386 1.011-.814.16-.436.248-.907.248-1.388Z" />
  </svg>
);
