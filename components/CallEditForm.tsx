...
const CallEditForm: React.FC<CallEditFormProps> = ({ call, onSave, onCreateCall, onCancel, members, users = [], isPrecheckTheme = false, isElecTheme = false, currentUserName, currentUserIsElecChecker = false, isDarkMode = false }) => {
  ...
  const checkboxColor = isElecTheme ? 'accent-[#2d5a9e]' : isPrecheckTheme ? 'accent-[#118f82]' : 'accent-[#0193be]';
      ...
      <form onSubmit={handleSubmit} className="space-y-3 text-sm">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <div className="md:col-span-2">
            ...
            <div className={`flex items-center border ${fieldBorder} rounded-md shadow-sm focus-within:ring-1 ${isElecTheme ? 'focus-within:ring-[#2d5a9e] focus-within:border-[#2d5a9e]' : isPrecheckTheme ? 'focus-within:ring-[#118f82] focus-within:border-[#118f82]' : 'focus-within:ring-[#0193be] focus-within:border-[#0193be]'} transition`}>
