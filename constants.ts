...
export const RANK_STYLES: Record<Rank, { backgroundColor: string; color: string; border?: string }> = {
  ...
  // プラチナランク（黄色系）
  'プラチナIMP':   { backgroundColor: '#d4a017', color: '#ffffff' },
  'プラ同意追跡': { backgroundColor: '#ffffff', color: '#b8860b', border: '1px solid #b8860b' },
  'プラ決済追跡': { backgroundColor: '#fef3cd', color: '#92650a' },
  'プラ両方追跡': { backgroundColor: '#f5cc5a', color: '#ffffff' },

  // 既存電気系ランク（RANK_STYLES完全網羅用）
  '電気前確':   { backgroundColor: '#f0e6ff', color: '#7c3aed' },
  '電気申込中': { backgroundColor: '#7c3aed', color: '#ffffff' },
  '電気完了':   { backgroundColor: '#e8f5e9', color: '#2e7d32' },
};
